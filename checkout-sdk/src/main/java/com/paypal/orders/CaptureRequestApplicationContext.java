...
// CaptureRequestApplicationContext.java
...
public class CaptureRequestApplicationContext {
	...
	*/
	@SerializedName(value = "supplementary_data", listClass = SupplementaryData.class)
	private List<SupplementaryData> supplementaryData;

	public List<SupplementaryData> supplementaryData() { return supplementaryData; }
	
	public CaptureRequestApplicationContext supplementaryData(List<SupplementaryData> supplementaryData) {
